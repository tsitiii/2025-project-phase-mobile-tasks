...
import 'features/chat/data/data_sources/user_remote_datasource.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => UpdateProdctUsecase(sl()));
  sl.registerLazySingleton(() => DeleteProdctUsecase(sl()));
  ...
  sl.registerLazySingleton<ProductRemoteDatasource>(
    () => ProductRemoteDatasource(client: sl(), sharedPreferences: sl()),
  );
  ...
  sl.registerLazySingleton<NetworkInfo>(
    () => NetworkInfoImpl(connectivityChecker: sl<Connectivity>()),
  );
